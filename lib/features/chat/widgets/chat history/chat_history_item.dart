...
class ChatHistoryItem extends StatelessWidget {
  ...
  static const _blueGradient = [Color.fromARGB(255, 99, 153, 241), Color.fromARGB(255, 91, 151, 247)];
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: InkWell(
        ...
        hoverColor: _blueGradient[0].withOpacity(0.05),
        highlightColor: Colors.transparent,
        splashColor: _blueGradient[0].withOpacity(0.1),
        child: Container(
              ...
              children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: _blueGradient[0].withOpacity(0.3),
                            blurRadius: 8,
                ...
                if (chat.ticketId != null) ...[
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: _blueGradient[0].withOpacity(0.1),
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                        color: _blueGradient[0].withOpacity(0.2),
                        width: 1,
                      ),
                    ),
                    child: Row(
                      ...
                      children: [
                        Icon(Icons.confirmation_number_rounded,
                            size: 16, color: _blueGradient[0]),
                        const SizedBox(width: 8),
                        Text(
                          _truncateTicketId(chat.ticketId!),
                          style: TextStyle(
                            fontSize: 13,
...
Future<void> _confirmDelete(BuildContext context) async {
  ...
  void _navigateToChat(BuildContext context) {
    Navigator.push(
      ...
      Provider.of<ChatProvider>(context, listen: false).loadUserChats(
        Provider.of<AuthProvider>(context, listen: false).currentUser?['user_id'],
      );
    });
  }
  ...
  String _truncateTicketId(String ticketId) {
    const maxLength = 20;
    if (ticketId.length <= maxLength) return ticketId;
    return '${ticketId.substring(0, maxLength ~/ 2)}...${ticketId.substring(ticketId.length - maxLength ~/ 2)}';
  }
}