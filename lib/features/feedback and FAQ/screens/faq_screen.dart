    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text('Loading FAQs...', style: TextStyle(color: Colors.blue.shade800)),
        ],
      ),
    );
  }
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text('Error loading FAQs:', style: TextStyle(color: Colors.red.shade800)),
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(Icons.hourglass_empty, color: Colors.blue.shade600, size: 40),
          const SizedBox(height: 16),
          Text('No FAQs available', style: TextStyle(color: Colors.blue.shade800)),
        ],
      ),
    );
  }
